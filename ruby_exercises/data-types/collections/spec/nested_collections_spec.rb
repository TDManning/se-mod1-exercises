RSpec.describe 'Nested Collections' do
  ...
  it 'test 6' do
    ...
    expect(pitchers).to eq(["Kenny", "Joan", "Shabaz"])
  end
  ...
  it 'test 20' do
    ...
    three_day_forecast = {"time" => "12:30", days: [{high: 70,low: 63,summary: "Mostly Sunny"},{high: 55,low: 47,summary: "Partly Cloudy"},{high: 77,low: 64,summary: "Sunny"}], "date" => "6-21-18",ref_num: 3456789765456787656}
