...
describe "#min/#max/#min_by/#max_by" do 
  ...
  it "returns the name with the lowest associated value" do 
    ...
    lowest_valued_pair = people.min_by do |pair|

      pair[1]
    end
      lowest_valued_name = lowest_valued_pair[0]
  ...
  xit "returns the name with the highest associated value" do 
    ...
    highest_valued_pair = people max_by do |pair|
      pair[0]
    end
      highest_valued_name = highest_valued_pair[0]
